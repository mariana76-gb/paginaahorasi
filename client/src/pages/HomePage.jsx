...
const productCards = [
  { title: 'Frappes', description: 'Batidos cremosos con hielo, café y toppings naturales.', price: '$95', image: 'https://images.unsplash.com/photo-1510627498534-cf7e9002facc?auto=format&fit=crop&w=800&q=80' },
  { title: 'Café Americano', description: 'Aroma intenso con cuerpo tostado para comenzar el día.', price: '$55', image: 'https://images.unsplash.com/photo-1485248199610-ff9f56b0d5a0?auto=format&fit=crop&w=800&q=80' },
  { title: 'Latte', description: 'Espuma sedosa y delicado sabor a leche con café espresso.', price: '$75', image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=800&q=80' },
  { title: 'Capuccino', description: 'Espuma cremosa con notas de cacao y canela.', price: '$80', image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=800&q=90' },
  { title: 'Chocolate', description: 'Chocolate caliente con malvaviscos y encanto relajante.', price: '$70', image: 'https://images.unsplash.com/photo-1511920170033-f8396924c348?auto=format&fit=crop&w=800&q=80' },
  { title: 'Té', description: 'Selección de tés herbales para calmar y reconfortar.', price: '$60', image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=800&q=80' },
  { title: 'Pan artesanal', description: 'Recién horneado con ingredientes naturales y sabor auténtico.', price: '$40', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=800&q=80' },
  { title: 'Postres', description: 'Caprichos dulces para compartir entre amigos.', price: '$65', image: 'https://images.unsplash.com/photo-1516685018646-54927c094f3b?auto=format&fit=crop&w=800&q=80' },
]

const testimonials = [
  { name: 'Mariana', text: 'Un lugar mágico con café delicioso y una vibra natural. ¡Me encanta el estilo dinosaurio!', stars: 5, photo: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=400&q=80' },
  { name: 'Carlos', text: 'Los frappes son increíbles y el ambiente es muy acogedor. Recomendado para cualquier amante del café.', stars: 5, photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80' },
  { name: 'Jessica', text: 'Servicio impecable, sabores auténticos y diseño muy cuidado. Ideal para trabajar o relajarse.', stars: 4, photo: 'https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=crop&w=400&q=80' },
]
...
const galleryImages = [
  ...
  'https://images.unsplash.com/photo-1532634726-8b9fb99825f1?auto=format&fit=crop&w=1200&q=80',
  'https://images.unsplash.com/photo-1464306076881-4c8aa04a38aa?auto=format&fit=crop&w=1200&q=80',
...
function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#10170F] text-white">
      <section id="inicio" className="relative bg-cover bg-center px-4 pb-20 pt-32 text-white" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1511920170033-f8396924c348?auto=format&fit=crop&w=1400&q=80)' }}>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#202b20]/90 shadow-2xl">
              <img src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1200&q=80" alt="Imagen de cafetería artesanal" className="h-full w-full object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#1f2a20]/90 shadow-2xl">
              <iframe className="h-80 w-full" src="https://www.youtube.com/embed/WEe01pEU0ko" title="Video promocional Frapessaurio" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </div>
        </div>
      </section>
